...
parser.add_argument("--data_path", type=str, help="Path of dataset", default=r"D:\Major8\-DSP391m-Forecasting-Financial-Time-Series-With-Transformer\craw_data\FPT_stock.xlsx")
